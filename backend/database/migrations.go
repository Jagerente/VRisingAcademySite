	...
	migrations [][]string = [][]string{
		...
		[]string{ //v12
			...
			`CREATE TABLE huntrewardvalues(
				rewardid INTEGER NOT NULL REFERENCES huntrewards(id),
				time INTEGER NOT NULL REFERENCES huntmodifiers(id), 
				modifier INTEGER NOT NULL REFERENCES hunttimes(id),
				minamount INTEGER NOT NULL,
				maxamount INTEGER NOT NULL,
				PRIMARY KEY(rewardid, time, modifier));`}}
)
